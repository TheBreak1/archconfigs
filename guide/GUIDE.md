...
Поставим до конца всё, что может пригодиться. Открываем _Alacritty_ и пишем:
...
По нажатию на Enter нас попросят написать наш пароль - пишем, Enter. На все последующие вопросы тоже жмём Enter.
  ...
  **Вот списочек всего, что может пригодиться**:
| Прога | Что это такое |
|--|--|
...
Далеко не весь софт находится на официальных репозиториях, но существует AUR, куда юзеры добавляют сторонние программы.

Для работы с AUR поставим две программы: _paru_ и _octopi_
