...
![{CFA6A66C-6E74-431F-8E46-557BCE919CA6}](https://github.com/user-attachments/assets/ee8b1751-8633-46ad-ae7a-206c9886cb6a)

Скачали, теперь откроем mc

>mc

Два окна слева и справа. Слева открыта наша рабочая папка, справа не важно, что.

Управление: *Tab* - Переключение между окнами; Вверх-Вниз-Enter понятно; F5 - копия выделенного в папку на другом окне; F10 - выход.

Табаемся, открываем папку archconfigs, выбираем папку .config и жмём F5. В новом окошке OK, в новом **страшном** окошке жмём *All*.


Всё готово, выходим на F10 и пишем >reboot

Комп идёт на перезагрузку, достаём флешку, чтобы не вернуться обратно, в BIOS выбираем Grub и перезапускаемся в наш **новый, БЛЕСТЯЩИЙ ARCH LINUX**.
...
| brightnessctl | Контроль яркости ноутбучного дисплея. |
| neofetch | ☆*:.｡. *выебон* .｡.:*☆ |
...
![{50005C3C-AF22-458E-AF23-9A97B56C5CB0}](https://github.com/user-attachments/assets/7ef2a1e5-c308-4d7c-89b9-2b65f39113dc)

Тут просто тык Enter и ожидаем...

Как всё загрузилось пишем `sudo systemctl enable ly`, подтверждаем паролем. Как всё сделается - можно перезапуститься и теперь вас будет культурно встречать *Ly*.



*Торч от флеш ультра закончился, дописываю...*

> Посмотрю paru+octopi внатуре
...
TODO: залить сюда wine-osu-7.15.2-x86_64.tar.xz
...
## Мб минигайд по удалению всего, что не надо для кругов (debloat xd)
