...
| geany | Графический текстовый редактор. Могло быть и лучше... |
| neofetch | ☆*:.｡. *выебоун* .｡.:*☆ |
...
Торч от флеш ультра закончился, дописываю...
TODO: готовые конфиги залить сюда, чтобы просто Ctrl+C Ctrl+V. А так можно вообще?
...
Затем открываем терминал и пишем:
...
Так же можно копирнуть с помощью `sudo mc` или *Nemo* c sudo правами.
